...
// Разбор одной карты вместе со всеми её объектами.
...
json::value ParseConfig(std::string_view text, const std::filesystem::path& json_path) {
    try {
